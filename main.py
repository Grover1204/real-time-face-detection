...
def main():
    parser = argparse.ArgumentParser(description="3D Face Reconstruction Pipeline - Stage 3")
    ...
    wireframe_preview_path = os.path.join(output_dir, f"{base_name}_wireframe_preview.png")
