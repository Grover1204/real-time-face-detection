...
def fit_basel_template(landmarks_3d, template_path="models/basel_template.obj"):
    ...
    print(
        f"Base fitted mesh has {len(mesh.vertices)} vertices and {len(mesh.triangles)} triangles"
    )
    ...
    print(
        f"Dense mesh has {len(dense_mesh.vertices)} vertices and {len(dense_mesh.triangles)} triangles"
    )
